    ...
    m_pFileListDlg(nullptr)
{
    ...
    ui->setupUi(this);
    ui->uploadFilePushButton->setStyleSheet("QPushButton { border: 2px solid #8f8f91; border-radius: 6px; \
    ...
    ui->fileListPushButton->setStyleSheet("QPushButton { border: 2px solid #8f8f91; border-radius: 6px; \
                                          background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, \
                                          stop: 0 #f6f7fa, stop: 1 #dadbde); \
                                          min-width: 75px; } \
                                      QPushButton:pressed { \
    ...
    ui->sendMsgPushButton->setStyleSheet("QPushButton { border: 2px solid #8f8f91; border-radius: 6px; \
                                         background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, \
    ...
    ui->showMsgTabWidget->setStyleSheet("QTabWidget::pane { border-top: 2px solid #C2C7CB;  }\
